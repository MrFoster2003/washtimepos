...
## Prompt template (reusable for every task)

Replace fields in `[ ]` for each session:

---

Read `ANTIGRAVITY.md` and `docs/PROJECT.md` before starting.
Also read `docs/FRONTEND.md` and `docs/BACKEND.md` to know what already exists.

**Task:** [PHASE NAME AND NUMBER]

**What this task includes:**
- [File 1 — short description]
- [File 2 — short description]
- [File 3 — short description]

**Tables involved:** [table1, table2, table3]

**Roles with access:** [ADMIN / SUPERVISOR / CASHIER / WASHER]

**Business rules to keep in mind:**
- [Relevant rule from PROJECT.md]
- [Another rule if applicable]

When done:
- Update `docs/FRONTEND.md` if you touched any UI
- Update `docs/BACKEND.md` if you touched any API route or service, including the tests section
- Confirm all tests pass before closing
